...
- (void)viewDidLoad {
    ...
    NSArray *imagesURLStrings = @[
                           ...
                           @"http://lilongcnc.cc/lauren_picture/test/0.png",
                           @"http://lilongcnc.cc/lauren_picture/test/1.png",
                           @"http://lilongcnc.cc/lauren_picture/test/2.png",
                           @"http://lilongcnc.cc/lauren_picture/test/3.png",
                           @"http://lilongcnc.cc/lauren_picture/test/4.png",
                           @"http://lilongcnc.cc/lauren_picture/test/5.png",
                           @"http://lilongcnc.cc/lauren_picture/test/6.png",
                           @"http://lilongcnc.cc/lauren_picture/test/7.png",
                           @"http://lilongcnc.cc/lauren_picture/test/8.png",
                           @"http://lilongcnc.cc/lauren_picture/test/9.png",
                           @"http://lilongcnc.cc/lauren_picture/test/10.png"
                           ];
