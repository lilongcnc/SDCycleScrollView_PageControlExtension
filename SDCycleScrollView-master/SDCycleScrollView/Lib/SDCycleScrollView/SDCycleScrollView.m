...
@implementation SDCycleScrollView{
    TAPageControl *previousPageControl;
    int previousIndexOnPageControl;
}
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case SDCycleScrollViewPageContolStyleAnimated:
        {
            ...
            pageControl.currentDotSize = CGSizeMake(12,5);
            pageControl.spacingBetweenDots = 15;
            pageControl.numberOfPages = self.imagePathsGroup.count; //很据这个创建对应数量的pageControl数组
            pageControl.dotColor = self.currentPageDotColor;
            pageControl.userInteractionEnabled = NO;
            pageControl.dotImage = [UIImage imageNamed:@"circular_white"];
            pageControl.currentDotImage = [UIImage imageNamed:@"ellipse_yellow"];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if ([self.pageControl isKindOfClass:[TAPageControl class]]) {
        ...
        if (indexOnPageControl != previousIndexOnPageControl) {
            
            
            NSLog(@"scrollViewDidScroll--- %d",indexOnPageControl);
            TAPageControl *pageControl = (TAPageControl *)_pageControl;
            pageControl.currentPage = indexOnPageControl;
            
            
            previousIndexOnPageControl = indexOnPageControl;
        }
